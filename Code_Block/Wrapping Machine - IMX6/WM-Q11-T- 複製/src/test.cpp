...
CHECK_STR stcTestCheckData[] = {
 ...
 /*06*/    { (unsigned char *)"LED >>>" , 0 , 0 , 0} ,
 /*07*/    { (unsigned char *)"GPIO >>>" , 0 , 0 , 0} ,
 /*08*/    { (unsigned char *)"Audio >>>" , 0 , 0 , 0} ,
 /*09*/    { (unsigned char *)"Lvds >>>" , 0 , 0 , 0} ,
 /*10*/    { (unsigned char *)"3AXIS >>>" , 0 , 0 , 0} ,
 /*11*/    { (unsigned char *)"TouchPanel >>>" , 0 , 0 , 0} ,
 /*12*/    { (unsigned char *)"USB >>>" , 0 , 0 , 0} ,
 /*13*/    { (unsigned char *)"WIFI >>>" , 0 , 0 , 0} ,
 /*14*/    { (unsigned char *)"Ethernet - eth0 >>>" , 0 , 0 , 0} ,
 /*15*/    { (unsigned char *)"Ethernet - eth1 >>>" , 0 , 0 , 0} ,
 /*16*/    { (unsigned char *)"RS232 >>>" , 0 , 0 , 0} ,
 /*17*/    { (unsigned char *)"DDR >>>" , 0 , 0 , 0} ,
 /*18*/    { (unsigned char *)"SDCARD >>>" , 0 , 0 , 0} ,
 /*19*/    { (unsigned char *)">>> Start Test " , 0 , 0 , 0} ,
 /*20*/    { (unsigned char *)"Number=[" , 0 , 0 , 1} ,
 /*21*/    { (unsigned char *)"Do you want to test again?" , 0 , 0 , 0} ,
 /*22*/    { (unsigned char *)"Save MP Test File Start." , 0 , 0 , 0} ,
 /*23*/    { (unsigned char *)"===========END==========" , 0 , 0 , 0} ,
 /*24*/    { (unsigned char *)"login:" , 0 , 0 , 0} ,
 /*25*/    { (unsigned char *)"root login on" , 0 , 0 , 0} ,
 /*26*/    { (unsigned char *)"No such file or directory" , 0 , 0 , 0} ,
 /*27*/    { (unsigned char *)"SYSTEM_TIME[" , 0 , 0 , 2} ,
 /*28*/    { (unsigned char *)"SERIAL_NUMBER[" , 0 , 0 , 3} ,
 /*29*/    { (unsigned char *)"Eth_Mac[" , 0 , 0 , 4} ,
 /*30*/    { (unsigned char *)"9514_Mac[" , 0 , 0 , 5} ,
 /*31*/    { (unsigned char *)"RUNIN_COUNT[" , 0 , 0 , 6} ,
 /*32*/    { (unsigned char *)"BSP_VERSION[" , 0 , 0 , 7} ,
 /*33*/    { (unsigned char *)"MCU_VERSION[" , 0 , 0 , 8} ,
} ;
        ...
        if ( ubCh == ']' )
        {
            switch ( iGetNumber )
            {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    memcpy( c9514_Mac , cTestNumberName , iTestStartGetNumber ) ;
                    SetWindowText( GetDlgItem( hRunDlgWnd , IDC_EDIT_INPUT ) , c9514_Mac ) ;
                    break;
                case 6 :
