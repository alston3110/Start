...
const REPORT_ITEM stcItem[] = {
    { (char *)"01  - LED(GPIO)          -- LED閃爍是否正確"                 , (char *)"N/A" } ,
    { (char *)"02  - LED(PWM)          -- LED漸亮是否正確"                  , (char *)"N/A" } ,
    { (char *)"03  - AUDIO                -- 音樂播放是否正確"              , (char *)"N/A" } ,
    { (char *)"04  - TOUCHPANEL   -- 觸控面板輸出是否正確"                  , (char *)"N/A" } ,
    { (char *)"05  - 3AXIS                 -- 三軸輸出是否正確"            , (char *)"N/A" } ,
    { (char *)"06  - SATA"                                                  , (char *)"N/A" } ,
    { (char *)"07  - Vedio"                                                  , (char *)"N/A" } ,
    { (char *)"08  - USB(USB1,USB2,USB3,OTG)"                               , (char *)"N/A" } ,
    { (char *)"09  - SDCARD(SD1,SD2)"                                       , (char *)"N/A" } ,
    { (char *)"10  - RS232(UART4,UART5)"                                    , (char *)"N/A" } ,
    { (char *)"11  - WIFI0"                                                 , (char *)"N/A" } ,
    { (char *)"12  - ETH0"                                                  , (char *)"N/A" } ,
} ;
