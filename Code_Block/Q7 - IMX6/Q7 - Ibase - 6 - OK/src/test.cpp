...
char cTestLoginPw[6]="admin";
char cTestLoginPassword[16];
char cTestProgName[128] ="/mnt/mmcblk1p1/MP_Test_Window/MP_Test";
...
CHECK_STR stcTestCheckData[] = {
    ...
    { (unsigned char *)"imx6-linux login:" , 0 , 0 , 0} ,
    { (unsigned char *)"~$" , 0 , 0 , 0} ,
    { (unsigned char *)"No such file or directory" , 0 , 0 , 0} ,
    { (unsigned char *)"Password:" , 0 , 0 , 0} ,
} ;
...
void vTest_login( void )
{
    ...
    }else if ( stcTestCheckData[25].iState  )
    {
        ...
        iTestCount = 0 ;
    }else if ( stcTestCheckData[27].iState  )
    {
        vStatus_Show("登入中..Password:") ;
        stcTestCheckData[27].iState = 0;
        cTestLoginPw[5] = 0x0d ;
        vRS232_Write((unsigned char *)cTestLoginPw,(long)6);
    }
}
