...
void vTest_MP_TEST_Select( void )
{
 ...
 //               cTestNum[0] = '1';
 //               cTestNum[1] = '7';
        }else if (iTestItem == 1){  //LVDS
                cTestNum[0] = '2';
                cTestNum[1] = '2';
        }else if (iTestItem == 2){  //3AXIS
                cTestNum[0] = '2';
                cTestNum[1] = '3';
        }else if (iTestItem == 3){  //SPI
                cTestNum[0] = '1';
                cTestNum[1] = '8';
        }else if (iTestItem == 4){  //AUDIO
                cTestNum[0] = '2';
                cTestNum[1] = '0';
        }else if (iTestItem == 5){  //USB
                cTestNum[0] = '0';
                cTestNum[1] = '3';
        }else if (iTestItem == 6){  //SDCARD
                cTestNum[0] = '1';
                cTestNum[1] = '2';
        }else if (iTestItem == 7){  //RS232
                cTestNum[0] = '1';
                cTestNum[1] = '0';
        }else if (iTestItem == 8){ //ETHERNET
                cTestNum[0] = '0';
                cTestNum[1] = '8';
        }
