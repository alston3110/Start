...
/*09*/    { (unsigned char *)"Q7_Machine login:" , 0 , 0 , 0} ,
...
void vTest_MP_TEST_Select( void )
{
    ...
    if(iReport_GetState( iTestItem ))
    {
        if (iTestItem == 0){
                ...
                cTestNum[0] = '2';
                cTestNum[1] = '2';
        }else if (iTestItem == 3){  //HDMI
                cTestNum[0] = '2';
                cTestNum[1] = '5';
        }else if (iTestItem == 4){  //AUDIO
                cTestNum[0] = '2';
                cTestNum[1] = '0';
        }else if (iTestItem == 5){  //3AXIS
                cTestNum[0] = '2';
                cTestNum[1] = '3';
        }else if (iTestItem == 6){  //SPI
                cTestNum[0] = '1';
                cTestNum[1] = '8';
        }else if (iTestItem == 7){  //USB
                cTestNum[0] = '0';
                cTestNum[1] = '3';
        }else if (iTestItem == 8){  //SDCARD
                cTestNum[0] = '1';
                cTestNum[1] = '2';
        }else if (iTestItem == 9){  //RS232
                cTestNum[0] = '1';
                cTestNum[1] = '0';
        }else if (iTestItem == 10){ //ETHERNET
                cTestNum[0] = '0';
                cTestNum[1] = '8';
        }else if (iTestItem == 11){ //ETHERNET1
                cTestNum[0] = '2';
                cTestNum[1] = '1';
        }else if (iTestItem == 12){ //WIFI
                cTestNum[0] = '0';
                cTestNum[1] = '4';
        }
...
void vTest_MP_TEST_testing( void )
{
    ...
    iTestCount++ ;
            ...
            switch (iTestItem) {
                case 0 :
                    SetWindowText( GetDlgItem( hRunDlgWnd , IDC_EDIT_INPUT2 ) , "LED(GPIO) 測試" ) ;
                    break;
                case 1 :
                    SetWindowText( GetDlgItem( hRunDlgWnd , IDC_EDIT_INPUT2 ) , "BUTTON 測試" ) ;
                    break;
                case 2 :
                    SetWindowText( GetDlgItem( hRunDlgWnd , IDC_EDIT_INPUT2 ) , "LVDS 測試" ) ;
                    break;
                case 3 :
                    SetWindowText( GetDlgItem( hRunDlgWnd , IDC_EDIT_INPUT2 ) , "HDMI 測試" ) ;
                    break;
                case 4 :
                ...
                case 5 :
                    ...
                    break;
                case 6 :
                    SetWindowText( GetDlgItem( hRunDlgWnd , IDC_EDIT_INPUT2 ) , "SPI 測試" ) ;
                    break;
                case 7 :
